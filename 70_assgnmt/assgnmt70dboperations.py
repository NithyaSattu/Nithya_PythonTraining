"""
70. Write a class(DB) program to create a table,
insert values, update values, delete values of the table.
All database operations code write in a file(db_operations.py)
and call these operations in another file( app.py).
In app.py create instance of the DB class and call all
the methods by passing some data.
"""
import sqlite3 as lite

class database:
    def connect(self):
        con = lite.connect('sampledb')
        cur = con.cursor()
        return con,cur
